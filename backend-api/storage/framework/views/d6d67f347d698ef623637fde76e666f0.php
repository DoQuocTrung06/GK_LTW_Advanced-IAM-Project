<div style='font-family: Arial, sans-serif; border: 1px solid #e2e8f0; padding: 30px; max-width: 500px; margin: 0 auto; border-radius: 12px; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);'>
    ...
    <div style='text-align: center; margin: 30px 0;'>
        <a href="<?php echo e($inviteLink); ?>" style='background-color: #4f46e5; color: white; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; display: inline-block; letter-spacing: 0.5px;'>
            Join Whiteboard
        </a>
    </div>
    ...
    <p style='color: #475569; font-size: 14px; line-height: 1.5;'>
        ...
        <a href="<?php echo e($inviteLink); ?>" style="color: #4f46e5; word-break: break-all;"><?php echo e($inviteLink); ?></a>
    </p>
